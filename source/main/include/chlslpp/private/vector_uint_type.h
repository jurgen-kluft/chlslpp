#ifndef __CHLSLPP_VECTOR_UINT_TYPE_H__
#define __CHLSLPP_VECTOR_UINT_TYPE_H__
...
namespace hlslpp
{
	...
	struct hlslpp_nodiscard uint1
	{
		...
		union
		{
			n128u vec;
			uint32_t u32[1];
			#include "chlslpp/private/swizzle/vector_uint_x.h"
		};
	...
	struct hlslpp_nodiscard uint2
	{
		...
		union
		{
			...
			uint32_t u32[2];
			#include "chlslpp/private/swizzle/vector_uint_x.h"
			#include "chlslpp/private/swizzle/vector_uint_y.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard uint3
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_uint_x.h"
			#include "chlslpp/private/swizzle/vector_uint_y.h"
			#include "chlslpp/private/swizzle/vector_uint_z.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard uint4
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_uint_y.h"
			#include "chlslpp/private/swizzle/vector_uint_z.h"
			#include "chlslpp/private/swizzle/vector_uint_w.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
};
