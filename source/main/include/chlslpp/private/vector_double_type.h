#ifndef __CHLSLPP_VECTOR_DOUBLE_TYPE_H__
#define __CHLSLPP_VECTOR_DOUBLE_TYPE_H__
...
hlslpp_module_export namespace hlslpp
{
	...
	struct hlslpp_nodiscard double1
	{
		...
		union
		{
			n128d vec;
			double f64[2];
			#include "chlslpp/private/swizzle/vector_double_x.h"
		};
	...
	struct hlslpp_nodiscard double2
	{
		...
		union
		{
			...
			double f64[2];
			#include "chlslpp/private/swizzle/vector_double_x.h"
			#include "chlslpp/private/swizzle/vector_double_y.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard double3
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_double_x.h"
			#include "chlslpp/private/swizzle/vector_double_y.h"
			#include "chlslpp/private/swizzle/vector_double_z.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard double4
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_double_y.h"
			#include "chlslpp/private/swizzle/vector_double_z.h"
			#include "chlslpp/private/swizzle/vector_double_w.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
};
