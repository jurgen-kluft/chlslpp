#ifndef __CHLSLPP_MATRIX_FLOAT_TYPE_H__
#define __CHLSLPP_MATRIX_FLOAT_TYPE_H__
...
hlslpp_module_export namespace hlslpp
{
	struct hlslpp_nodiscard float1x1
	{
		...
		union
		{
			n128 vec;
			float f32[4];
			#include "chlslpp/private/swizzle/matrix_row0_1.h"
		};
	...
	struct hlslpp_nodiscard float1x2
	{
		...
		union
		{
			n128 vec;
			float f32[4];
			#include "chlslpp/private/swizzle/matrix_row0_2.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard float2x2
	{
		...
		#include "chlslpp/private/transform/float2x2.h"
	...
	struct hlslpp_nodiscard float3x3
	{
		...
		#include "chlslpp/private/transform/float3x3.h"
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/matrix_row0_1.h"
			#include "chlslpp/private/swizzle/matrix_row0_2.h"
			#include "chlslpp/private/swizzle/matrix_row0_3.h"
		};
		...
		union
		{
			n128 vec1;
			float f32_1[3];
			#include "chlslpp/private/swizzle/matrix_row1_1.h"
			#include "chlslpp/private/swizzle/matrix_row1_2.h"
			#include "chlslpp/private/swizzle/matrix_row1_3.h"
		};
		...
		union
		{
			n128 vec2;
			float f32_2[3];
			#include "chlslpp/private/swizzle/matrix_row2_1.h"
			#include "chlslpp/private/swizzle/matrix_row2_2.h"
			#include "chlslpp/private/swizzle/matrix_row2_3.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard float4x4
	{
		...
		union
		{
			...
			struct
			{
				union
				{
					...
					#include "chlslpp/private/swizzle/matrix_row0_2.h"
					#include "chlslpp/private/swizzle/matrix_row0_3.h"
					#include "chlslpp/private/swizzle/matrix_row0_4.h"
				};
				...
				union
				{
					...
					#include "chlslpp/private/swizzle/matrix_row1_2.h"
					#include "chlslpp/private/swizzle/matrix_row1_3.h"
					#include "chlslpp/private/swizzle/matrix_row1_4.h"
				};
			};
			HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
		};
		...
		union
		{
			...
			struct
			{
				union
				{
					...
					#include "chlslpp/private/swizzle/matrix_row2_2.h"
					#include "chlslpp/private/swizzle/matrix_row2_3.h"
					#include "chlslpp/private/swizzle/matrix_row2_4.h"
				};

				union
				{
					#include "chlslpp/private/swizzle/matrix_row3_1.h"
					#include "chlslpp/private/swizzle/matrix_row3_2.h"
					#include "chlslpp/private/swizzle/matrix_row3_3.h"
					#include "chlslpp/private/swizzle/matrix_row3_4.h"
				};
			};
			HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
		};
		...
		#include "chlslpp/private/transform/float4x4.h"
	};
};
#endif
