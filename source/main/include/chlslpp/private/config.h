#ifndef __CHLSLPP_CONFIG_H__
#define __CHLSLPP_CONFIG_H__
...
#include "chlslpp/private/type_traits.h"
#include "chlslpp/private/bitmask.h"
...
// implementation we want.
	...
	#include "chlslpp/private/platforms/scalar.h"

#elif defined(HLSLPP_WASM)

	#include "chlslpp/private/platforms/wasm.h"

#elif defined(HLSLPP_SSE)

	#include "chlslpp/private/platforms/sse.h"

#elif defined(HLSLPP_ARM)

	#include "chlslpp/private/platforms/neon.h"

#elif defined(HLSLPP_360)

	#include "chlslpp/private/platforms/xbox360.h"
