#ifndef __CHLSLPP_VECTOR_INT_TYPE_H__
#define __CHLSLPP_VECTOR_INT_TYPE_H__
...
hlslpp_module_export namespace hlslpp
{
	...
	struct hlslpp_nodiscard int1
	{
		...
		union
		{
			n128i vec;
			int32_t i32[1];
			#include "chlslpp/private/swizzle/vector_int_x.h"
		};
	...
	struct hlslpp_nodiscard int2
	{
		...
		union
		{
			...
			int32_t i32[2];
			#include "chlslpp/private/swizzle/vector_int_x.h"
			#include "chlslpp/private/swizzle/vector_int_y.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard int3
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_int_x.h"
			#include "chlslpp/private/swizzle/vector_int_y.h"
			#include "chlslpp/private/swizzle/vector_int_z.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard int4
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_int_y.h"
			#include "chlslpp/private/swizzle/vector_int_z.h"
			#include "chlslpp/private/swizzle/vector_int_w.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
};
