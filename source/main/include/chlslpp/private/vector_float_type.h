#ifndef __CHLSLPP_VECTOR_FLOAT_TYPE_H__
#define __CHLSLPP_VECTOR_FLOAT_TYPE_H__
...
hlslpp_module_export namespace hlslpp
{
	...
	struct hlslpp_nodiscard float1
	{
		...
		union
		{
			n128 vec;
			float f32[1];
			#include "chlslpp/private/swizzle/vector_float_x.h"
		};
	...
	struct hlslpp_nodiscard	float2
	{
		...
		union
		{
			...
			float f32[2];
			#include "chlslpp/private/swizzle/vector_float_x.h"
			#include "chlslpp/private/swizzle/vector_float_y.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard	float3
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_float_x.h"
			#include "chlslpp/private/swizzle/vector_float_y.h"
			#include "chlslpp/private/swizzle/vector_float_z.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
	...
	struct hlslpp_nodiscard	float4
	{
		...
		union
		{
			...
			#include "chlslpp/private/swizzle/vector_float_y.h"
			#include "chlslpp/private/swizzle/vector_float_z.h"
			#include "chlslpp/private/swizzle/vector_float_w.h"
		};
		HLSLPP_WARNING_ANONYMOUS_STRUCT_UNION_END
	};
};
